    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="shangjiaId" name="shangjiaId" type="hidden">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="现价/积分" prop="goodsNewMoney">
                       <el-input v-model="ruleForm.goodsNewMoney"
                                 placeholder="现价/积分" clearable  :readonly="ro.goodsNewMoney"></el-input>
                   </el-form-item>
                   <div v-else>
                       <el-form-item class="input" label="现价/积分" prop="goodsNewMoney">
                           <el-input v-model="ruleForm.goodsNewMoney"
